...
if(isset($_POST['update'])){
            ...
            $sql="UPDATE posts SET title='$title',content='$content',date='$date',image='$file_store' WHERE id=$pid";
            if($title==""||$content==""){
...
if(mysqli_num_rows($res)>0){
    while ($row = mysqli_fetch_assoc($res)){
        ...
        echo "<input type='file' name='image'><br/><tr><tr><input placeholder='Title' name='title' type='text' value='$title' autofocus size='48'><br/><br/>
            <tr><tr><textarea placeholder='Content' name='content' rows='20' cols='50'>$content</textarea><br/>
            <tr><tr>";  
    }
}
?>
