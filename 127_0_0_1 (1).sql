...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2019 at 08:54 AM
...
-- Database: `comps`
--
CREATE DATABASE IF NOT EXISTS `comps` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `comps`;
...
-- Database: `dd`
--
CREATE DATABASE IF NOT EXISTS `dd` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dd`;
...
(1, 'Ashutosh Namdev', 'ashu', '123456'),
(2, 'Sakshi Rohida', 'sakshi', '123456'),
(3, 'Gurpreet Sir', 'gurpreetsir', '123456'),
(1, 'testcollege', '30', '50'),
(2, 'comps test 1', '99', '99'),
(3, 'comps test 2', '20', '20'),
(4, 'comps test 5', '50', '96');
...
(0, 'Ashutosh', 'Namdev', 'ashu1234', '1234', 'male', 88, 320, 'comps');
...
-- Database: `extc`
--
CREATE DATABASE IF NOT EXISTS `extc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `extc`;
...
--
ALTER TABLE `extc_colleges`
  MODIFY `ecid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- Database: `it`
--
...
INSERT INTO `it_colleges` (`itcid`, `itname`, `hsc`, `jee`) VALUES
(1, 'it test 1', 11, 11);
...
--
ALTER TABLE `it_colleges`
  MODIFY `itcid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- Database: `mech`
--
CREATE DATABASE IF NOT EXISTS `mech` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mech`;
...
(1, 'root', 'server', 'all database', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"comps\",\"db\",\"dd\",\"extc\",\"it\",\"mech\",\"phpmyadmin\",\"project\",\"test\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"project\",\"table\":\"posts\"},{\"db\":\"project\",\"table\":\"users\"},{\"db\":\"project\",\"table\":\"newusers\"},{\"db\":\"project\",\"table\":\"evo_coll_locales\"},{\"db\":\"project\",\"table\":\"evo_categories\"},{\"db\":\"project\",\"table\":\"evo_blogusers\"},{\"db\":\"project\",\"table\":\"evo_blogs\"},{\"db\":\"project\",\"table\":\"evo_bloggroups\"},{\"db\":\"project\",\"table\":\"evo_basedomains\"},{\"db\":\"project\",\"table\":\"evo_i18n_translated_string\"}]');
...
('', '2019-10-05 05:22:41', '{\"Console\\/Mode\":\"collapse\"}'),
('root', '2019-10-05 06:54:15', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":274}');
...
INSERT INTO `posts` (`id`, `title`, `content`, `date`, `author`, `image`) VALUES
(2, 'TEST 1', 'This is my first test blog.', 'Saturday 5th of October 2019 08:46:45 AM', 'ashu9111', 'image/Untitled.png'),
(3, 'TEST 2', 'this is my second blogging test.', 'Saturday 5th of October 2019 08:48:47 AM', 'ashu9111', 'image/ashu_photo.jpg');
...
(1, 'ashu9111', 'ashutosh.namdev.9@gmail.com', 'ashu');
