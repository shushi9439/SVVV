                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown has-submenu">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdown02">
                                    <li><a class="dropdown-item" href="single-slider.php">Blog <span class="hidden-md-down hidden-sm-down hidden-xs-down"><i class="fa fa-angle-right"></i></span></a>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="single-fullwidth.php">Write A Blog</a></li>
                                            <li><a class="dropdown-item" href="single-slider.php">Blogs</a></li>
                                        </ul>
                                    </li>
...
if(mysqli_num_rows($res)>0){
    while($row=mysqli_fetch_assoc($res)){
        ...
        $content=$row['content'];
        $date=$row['date'];
        $file_store=$row['image'];

        //$output = $bbcode->Parse($content);
        $posts = "<section class='section first-section'><div class='container-fluid'><div class='masonry-blog clearfix'><div class='left-side'><div class='masonry-box post-media'><img src='$file_store' alt='' href='single-slider.php' class='img-fluid'><div class='shadoweffect'><div class='shadow-desc'><div class='blog-meta'><h4><a href='single-slider.php'>$title</a></h4><small><a href='single-slider.php'>$date</a></small><small><a href='single-slider.php'>by $author</a></small></div></div></div></div></div></div></div></section>";
        echo $posts;
    }
